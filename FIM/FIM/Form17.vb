Public Class Form17
    Function Buka(ByVal Z As Object) As Form
        ...
        Return Z
    End Function
    Private Sub Form17_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        PictureBox1.Focus()
    End Sub
    ...
    Private Sub A_Click(sender As Object, e As EventArgs) Handles A.Click
        mundur.Enabled = False
        Form1.Button16.Text = "A"
        Buka(Form1)
        Form1.Button16.BackColor = Color.HotPink
    ...
    Private Sub B_Click(sender As Object, e As EventArgs) Handles B.Click
        mundur.Enabled = False
        Form1.Button16.Text = "B"
        Buka(Form1)
        Form1.Button16.BackColor = Color.Yellow
    ...
    Private Sub C_Click(sender As Object, e As EventArgs) Handles C.Click
        mundur.Enabled = False
        Form1.Button16.Text = "C"
        Buka(Form1)
        Form1.Button16.BackColor = Color.GreenYellow
    ...
    Private Sub D_Click(sender As Object, e As EventArgs) Handles D.Click
        mundur.Enabled = False
        Form1.Button16.Text = "D"
        Buka(Form1)
        Form1.Button16.BackColor = Color.Cyan
    ...
    Private Sub BE_Click(sender As Object, e As EventArgs) Handles BE.Click
        mundur.Enabled = False
        Form1.Button16.Text = "E"
        Buka(Form1)
        Form1.Button16.BackColor = Color.Orange
    ...
    Private Sub F_Click(sender As Object, e As EventArgs) Handles F.Click
        mundur.Enabled = False
        Form1.Button16.Text = "F"
        Buka(Form1)
        Form1.Button16.BackColor = Color.BlueViolet
    ...
    Private Sub TT_Click(sender As Object, e As EventArgs) Handles TT.Click
        ...
        Form1.Button16.Text = " "
        Buka(Form1)
        Form1.Button16.BackColor = Color.Gainsboro
        A.Enabled = True
        B.Enabled = True
        C.Enabled = True
        D.Enabled = True
