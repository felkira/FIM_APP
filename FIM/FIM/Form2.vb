Public Class Form2
    ...
    Private Sub A_Click(sender As Object, e As EventArgs) Handles A.Click
        ...
        Buka(Form1)
        Form1.Button1.BackColor = Color.HotPink
    ...
    Private Sub B_Click(sender As Object, e As EventArgs) Handles B.Click
        mundur.Enabled = False
        Form1.Button1.Text = "B"
        Buka(Form1)
        Form1.Button1.BackColor = Color.Yellow
    ...
    Private Sub C_Click(sender As Object, e As EventArgs) Handles C.Click
        mundur.Enabled = False
        Form1.Button1.Text = "C"
        Buka(Form1)
        Form1.Button1.BackColor = Color.GreenYellow
    ...
    Private Sub D_Click(sender As Object, e As EventArgs) Handles D.Click
        mundur.Enabled = False
        Form1.Button1.Text = "D"
        Buka(Form1)
        Form1.Button1.BackColor = Color.Cyan
    ...
    Private Sub F_Click(sender As Object, e As EventArgs) Handles F.Click
        mundur.Enabled = False
        Form1.Button1.Text = "F"
        Buka(Form1)
        Form1.Button1.BackColor = Color.BlueViolet
    ...
    Private Sub TT_Click(sender As Object, e As EventArgs) Handles TT.Click
        ...
        Form1.Button1.Text = " "
        Buka(Form1)
        Form1.Button1.BackColor = Color.Gainsboro
        A.Enabled = True
        B.Enabled = True
        C.Enabled = True
        D.Enabled = True
